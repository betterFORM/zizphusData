...
declare variable $local-dir := '/resources/services/repositories/local';
...
local:mkcol('/db/', $local-dir || '/organistations'),
local:mkcol('/db/', $local-dir || '/subjects'),
local:mkcol('/db/', $local-dir || '/getty/aat'),
local:mkcol('/db/', $local-dir || '/viaf/xml'),
...
xmldb:store-files-from-pattern($local-collection || '/organistations', $dir || $local-dir || '/organistations', "*.xml"),
xmldb:store-files-from-pattern($local-collection || '/subjects', $dir || $local-dir || '/subjects', "*.xml"),
xmldb:store-files-from-pattern('/db/system/config/db/resources/services/repositories/local', $dir || '/system/config/db/resources/services/repositories/local', "*.xconf"),
util:log($log-level, "... DONE"),
