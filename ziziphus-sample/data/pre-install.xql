...
xmldb:store-files-from-pattern($pp-collection, xmldb:encode($dir || $pp-dir), "w_*.xml"),
xmldb:store-files-from-pattern($pp-collection || '/VRA_images', xmldb:encode($dir || $pp-dir || '/VRA_images'), "i_*.xml"),
